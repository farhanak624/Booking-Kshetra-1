...
export const metadata: Metadata = {
  ...
  description:
    "Experience tranquility at Kshetra Retreat Resort. Book rooms, yoga sessions, and adventure activities in beautiful Kerala.",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`scroll-smooth ${monomaniacOne.variable} ${annieUseYourTelescope.variable} ${waterBrush.variable} ${urbanist.variable}`}
    >
